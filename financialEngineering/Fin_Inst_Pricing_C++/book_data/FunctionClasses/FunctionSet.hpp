...
public:
	...
	typedef list<pair<string, ScalarValuedFunction<D,R,I> > >::iterator iterator;
	typedef list<pair<string, ScalarValuedFunction<D,R,I> > >::const_iterator const_iterator;
