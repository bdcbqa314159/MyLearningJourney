...
// Selectors
template <class V>
const V& MatrixStructure<V>::Element(size_t row, size_t column) const
...
// Modifiers
template <class V>
void MatrixStructure<V>::Element(size_t row, size_t column, const V& val)
...
template <class V>
V& MatrixStructure<V>::operator () (size_t row, size_t column)
{ // Get element at position
...
template <class V>
const V& MatrixStructure<V>::operator () (size_t row, size_t column) const
{ // Get element at position
