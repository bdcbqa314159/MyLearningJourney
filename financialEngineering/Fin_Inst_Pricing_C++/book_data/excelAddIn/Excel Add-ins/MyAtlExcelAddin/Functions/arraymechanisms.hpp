// arraymechanisms.hpp
//
// Sets of functions for common vector and matrix manipultion. These
// are useful utility functions.
//
// (C) Datasim Education BV 2003

// Moment and were median defined twice.
// Mean and Standard deviation had variable names that conflicted with function names
...
enum NumDiffType {Forward, Backward, Centred};
...
//// Useful functions for Numerical Linear Algebra //////////////////
template <class V, class I> bool positiveDiagonalElements(const NumericMatrix<V,I>& matrix);
